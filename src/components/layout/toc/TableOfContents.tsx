...
export function TableOfContents() {
  ...
  return (
    <>
      ...
      <div className="fixed top-[20px] right-[24px] z-50 flex items-center justify-center w-[30px] h-[30px] box-content border border-slate-200 rounded-[8px] bg-white hover:bg-slate-50 transition-colors desktop:hidden ">
